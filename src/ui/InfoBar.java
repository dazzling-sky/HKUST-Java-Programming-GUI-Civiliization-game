...
public class InfoBar extends VBox {
    ...
    public InfoBar(GameMap gameMap) {
        ...
        Label ministersLabel = new Label("Ministers");
        Label technologiesLabel = new Label("Technologies");
        Label neighborsLabel = new Label("Neighbors");
        ...
        troopSlider.valueProperty().addListener((ov, oldVal, newVal)-> {
            lbSlider.setText("The value of the slider is " + newVal);
        });

        Pane buttonGroup = createActionButtonGroup();

        getChildren().addAll(infoGroup, citiesLabel, cityListView, ministersLabel, ministerListView, technologiesLabel, technologyListView, neighborsLabel, neighborListView,
                lbSlider, troopSlider, buttonGroup, logsLabel, logListView);
    ...
    private void actionButtonHandler(int actionNumber) {
        ...
        int valueTroop = (int)troopSlider.getValue();

        gameActionHandler.handle(actionNumber, selectedMinister, selectedCity, selectedNeighbor, selectedTechnology, valueTroop);
    }
